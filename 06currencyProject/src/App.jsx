...
function App() {
    ...
    const convert = () => {
        ...
        if (conversionRate) {
            ...
            setConvertedAmount(0); // Fallback in case of undefined conversion rate
        }
    };
                    ...
                    >
                        <div className="w-full mb-1">
                            <InputBox
                                ...
                                selectCurrency={from}
                                onAmountChange={(amount) => setAmount(Number(amount) || 0)}
                            />
                        </div>
                        ...
                        <button type="submit" className="w-full bg-blue-600 text-white px-4 py-3 rounded-lg">
                            Convert {from.toUpperCase()} to {String(to).toUpperCase()}
                        </button>
                    </form>
                </div>
            </div>
